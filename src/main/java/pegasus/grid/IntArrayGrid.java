...
public class IntArrayGrid implements IntGrid {
     ...
     */
    public IntArrayGrid(int rows, int columns, IntBinaryOperator generator) {
        this(rows, columns);
        setAll(generator);
    }
     ...
     */
    public IntArrayGrid(IntGrid g, int r1, int c1, int r2, int c2) {
        this.rows = r2 - r1;
        this.columns = c2 - c1;
     ...
     */
    @Override
    public int[] row(int r) throws IndexOutOfBoundsException {
     ...
     */
    @Override
    public int[] column(int c) throws IndexOutOfBoundsException {
     ...
     */
    @Override
    public boolean containsAll(IntGrid g) {
     ...
     */
    @Override
    public int get(int r, int c) throws BinaryIndexOutOfBoundsException {
     ...
     */
    @Override
    public IntContainer getReference(int r, int c) throws BinaryIndexOutOfBoundsException {
        if (r < 0 || r >= rows || c < 0 || c >= columns) {
            throw new BinaryIndexOutOfBoundsException(r, c);
        }

        return new IntArrayElementReference(values, r * columns + c, false);
    }
     ...
     */
    @Override
    public void set(int r, int c, int value) throws BinaryIndexOutOfBoundsException {
        if (r < 0 || r >= rows || c < 0 || c >= columns) {
            throw new BinaryIndexOutOfBoundsException(r, c);
        }
     ...
     */
    @Override
    public void fillRange(int r1, int c1, int r2, int c2, int value) throws BinaryIndexOutOfBoundsException {
     ...
     */
    @Override
    public void fillRange(int r1, int c1, int r2, int c2, IntGrid g)
     ...
     */
    @Override
    public void setAll(IntBinaryOperator generator) {
        int i = 0;

        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < columns; c++) {
                values[i++] = generator.applyAsInt(r, c);
            }
        }
    }
     ...
     */
    @Override
    public IntGrid map(IntUnaryOperator mapper) {
     ...
     */
    @Override
    public <U> Grid<U> mapToObj(IntFunction<? extends U> mapper) {
     ...
     */
    @Override
    public DoubleGrid mapToDouble(IntToDoubleFunction mapper) {
     ...
     */
    @Override
    public LongGrid mapToLong(IntToLongFunction mapper) {
     ...
     */
    @Override
    public IntGrid merge(IntGrid g, IntBinaryOperator merger)
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < columns; c++) {
                int i = r * columns + c;
                result.values[i] = merger.applyAsInt(values[i], g.get(r, c));
            }
        }
    ...
    public IntGrid transpose() {
        IntArrayGrid result = new IntArrayGrid(columns, rows);
     ...
     */
    @Override
    public void forEachIndexed(BinaryIndexedIntConsumer action) {
        int i = 0;

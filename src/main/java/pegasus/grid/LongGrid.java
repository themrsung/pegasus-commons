...
public interface LongGrid extends BaseGrid<Long>, BinaryIndexedLongIterable {
     ...
     * @throws BinaryIndexOutOfBoundsException When the provided index is out of bounds
     */
    LongContainer getReference(int r, int c) throws BinaryIndexOutOfBoundsException;
     ...
     */
    void fillRange(int r1, int c1, int r2, int c2, long value) throws BinaryIndexOutOfBoundsException;
